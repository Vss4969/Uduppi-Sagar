    ...
    <body>
        <header>
          ...
          <div style="display: flex;justify-content: center;">
            <form class="loginbox" action="AddServlet" method="post"> 
              <h1>Sign Up</h1> 
                <input type="text" name="usernm" id="" placeholder="Username"> 
                <input type="password" name="passwd" id="" placeholder="Password"> 
                <input type="text" name="email" id="" placeholder="Email"> 
                <input type="text" name="phone" id="" placeholder="Phone No."> 
                <input type="file" name="img" id="" placeholder="Image" hidden> 
                <input type="text" name="address" id="" placeholder="Address">
                <input type="submit" name="" value="Sign Up">
                <div style="color:red;">
                	<% 
                		
                	 	String print = (String)session.getAttribute("check");
                		String hello = "hello";
                	    if(print!=null) {%>
                			<%=print%>
                			<%session.invalidate();
